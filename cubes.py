...
def generate_polycubes(n, use_cache=False, enable_multicore=False):
    """
    ...
    if(use_cache and cache_exists(n)):
        ...
        results = dispatch_tasks(hash_cubes_task, generate_polycubes(n-1, use_cache, enable_multicore), enable_multicore)
